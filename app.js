...
const arrayOfPeople = [
  { name: 'Fatima-ezzahra', age: 23, favoriteFoods: ['couscous', 'briwa'] },
  { name: 'Rima', age: 26, favoriteFoods: ['shawarma', 'pizz 4 saison'] },
  { name: 'Mehdi', age: 30, favoriteFoods: ['spaghetti', 'rfisa'] }
];
...
Person.find({ name: 'Fatima-ezzahra' })
  .then(data => {
...
const personName = 'Fatima-ezzahra';
...
Person.deleteOne({ name: 'Fatima-ezzahra' })
  .then(result => {
    console.log(result);
  })
  .catch(err => {
